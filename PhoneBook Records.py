...
def EditEntry():
    change = input("Please input the contact you would like to change: ")
    for index in range(len(contactList)):
        if contactList[index].name == change:
            change_to = input("Would you like to change the name or the number? ")
            if change_to == ("name"):
                change_made = input("Please change the name: ")
                contactList[index].name = change_made
                print(contactList[index].name, contactList[index].number)
            elif change_to == ("number"):
                change_made = input("Please change the number: ")
                contactList[index].number = change_made
                print(contactList[index].name, contactList[index].number)
...
def DeleteEntry(contactList):
    ...
    for index in range(len(contactList)):
        if contactList[index].name == delete:
...
def GetContactIndex():
    name_to_find = input("Please enter contact name: ")
    for index in range(len(contactList)):
        if contactList[index].name == name_to_find:
